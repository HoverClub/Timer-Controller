...
void cleanUpPosixTZStr(char *tz_str, size_t tz_str_len); // tz_str_len is sizeof of tz_str storage, e.g.  cleanUpPosixTZStr(timerConfig.tzStr,sizeof(timerConfig.tzStr));
